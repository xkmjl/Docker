    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel_descriptions_en', models.TextField(null=True)),
                ('hotel_descriptions_ru', models.TextField(null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_type', models.CharField(choices=[('люкс', 'люкс'), ('семейный', 'семейный'), ('одноместный', 'одноместный'), ('двухместнный', 'двухместнный')], max_length=16)),
                ('room_status', models.CharField(choices=[('свободный', 'свободный'), ('забронирован', 'забронирован'), ('занят', 'занят')], default='свободный', max_length=16)),
